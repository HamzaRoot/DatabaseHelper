package com.rootcoder.mvvmdemo.helpingclasses;
...
public class ImagePipelineConfigUtils {
    ...
    public static ImagePipelineConfig getDefaultImagePipelineConfig(Context context) {
        ...
        DiskCacheConfig diskSmallCacheConfig = DiskCacheConfig.newBuilder(context).setBaseDirectoryPath(new File(Helper.Companion.getAppFolder(context)))//Cache image base path
        ...
        DiskCacheConfig diskCacheConfig = DiskCacheConfig.newBuilder(context).setBaseDirectoryPath(new File(Helper.Companion.getAppFolder(context)))//Cache image base path
